	...
	public static void main(String [] args)
	{
        ...
        while (programIsRunning == true)
        {
            ...
            if (numOfChioce == 1)
            {
                ...
                System.out.println(sumRepetition); 
                System.out.println(); // -------------------------------------------------------------
            }
            else if (numOfChioce == 2)
            {
                ...
                {
                    sumArmstrong +=  Integer.parseInt(parts[index]) * Integer.parseInt(parts[index]) * Integer.parseInt(parts[index]);
                }
            ...
            else if (numOfChioce == 5)
            {
                ...
                for (int index = 0; numberInput.length() > index; index++)
                {
                    ...
                    {
                        sumEvenDig += Integer.parseInt(parts[index]);
                        NumEvenDig++;
                    }
                    else
                    {
                        sumOddDig += Integer.parseInt(parts[index]);
                        numOddDig++;
                    }
                }
            ...
            else if (numOfChioce == 6)
            {
                ...
                {
                    if ((Integer.parseInt(parts[index])) != (Integer.parseInt(parts[palindromeInput.length() - index - 1])))
                    {
                        isPalindrome = false; 
            ...
            else if (numOfChioce == 8)
            {
                ...
                {
                    powerSum *= baseNumInput;
                    whileLoop++;
                }
                System.out.println(baseNumInput + " to the power of " + exponentNumInput + " is " + powerSum);
                System.out.println(); // -----------------------------------------
            }
            else if (numOfChioce == 9)
            {
